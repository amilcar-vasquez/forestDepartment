...
class Application(models.Model):
    ...
    importer_state = models.CharField(max_length=100, blank=True, null=True)
    importer_zip = models.CharField(max_length=100, blank=True, null=True)
    ...
    exporter_state = models.CharField(max_length=100, blank=True, null=True)
    exporter_zip = models.CharField(max_length=100, blank=True, null=True)
    exporter_country    = models.CharField(max_length=100)
    exporter_phone = PhoneNumberField(region='US', blank=True, null=True)
    exporter_company_name = models.CharField(max_length=100, blank=True, null=True)
    exporter_email = models.CharField(max_length=100, blank=True, null=True)
    exporter_social = models.CharField(max_length=100, blank=True, null=True) 
    exporter_id_number = models.CharField(max_length=100, blank=True, null=True) 
    exporter_business_number = PhoneNumberField(region='US', blank=True, null=True)
    exporter_registry_number = models.CharField(max_length=100, blank=True, null=True)
